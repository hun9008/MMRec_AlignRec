...
class ALIGNREC_STORE(GeneralRecommender):
    def __init__(self, config, dataset):
        super(ALIGNREC_STORE, self).__init__(config, dataset)
        self.sparse = True
    ...
    def forward(self, adj, users=None, train=False):
        ...
        return all_embeddings_users, all_embeddings_items, mm_item, id_item
    ...
    def full_sort_predict(self, interaction):
        ...
        restore_user_e, restore_item_e, mm_item, id_item = self.forward(self.norm_adj)
        u_embeddings = restore_user_e[user]

        save_dir = os.path.join("saved_emb", self.dataset_name, "AlignRec")
