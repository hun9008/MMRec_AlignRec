...
class ALIGNREC_INPUT_CL_ANCHOR_MMTV_IISIM_ALL_WO_P_0915(GeneralRecommender):
    def __init__(self, config, dataset):
        super(ALIGNREC_INPUT_CL_ANCHOR_MMTV_IISIM_ALL_WO_P_0915, self).__init__(config, dataset)
        self.sparse = True
