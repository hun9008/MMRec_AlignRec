...
class ALIGNREC_INPUT_CL_ANCHOR_TV_0512(GeneralRecommender):
    def __init__(self, config, dataset):
        super(ALIGNREC_INPUT_CL_ANCHOR_TV_0512, self).__init__(config, dataset)
        self.sparse = True
    ...
    def calculate_loss(self, interaction, not_train_ui=False):
        ...
        # L2 Loss 추가
        cl_id = self.InfoNCE(h_mm_i_fusion, h_id_i_fusion, 0.2)
        cl_v  = self.InfoNCE(h_mm_i_fusion, h_v_fusion, 0.2)
        cl_t  = self.InfoNCE(h_mm_i_fusion, h_t_fusion, 0.2)
