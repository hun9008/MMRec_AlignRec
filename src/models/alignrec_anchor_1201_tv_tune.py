...
class ALIGNREC_ANCHOR_1201_TV_TUNE(GeneralRecommender):
    def __init__(self, config, dataset):
        super(ALIGNREC_ANCHOR_1201_TV_TUNE, self).__init__(config, dataset)
        self.sparse = True
    ...
    def calculate_loss(self, interaction, not_train_ui=False):
        ...
        h_v_fusion = self.W_v(v_embeds_items)                  # (n_items, d)
        h_t_fusion = self.W_t(t_embeds_items)                  # (n_items, d)
