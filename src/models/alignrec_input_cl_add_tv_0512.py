...
class ALIGNREC_INPUT_CL_ADD_TV_0512(GeneralRecommender):
    def __init__(self, config, dataset):
        super(ALIGNREC_INPUT_CL_ADD_TV_0512, self).__init__(config, dataset)
        self.sparse = True
    ...
    def calculate_loss(self, interaction, not_train_ui=False):
        ...
        cl_mm = self.InfoNCE(h_id_i_fusion, h_v_fusion, 0.2) + self.InfoNCE(h_id_i_fusion, h_t_fusion, 0.2)
