...
class ALIGNREC_ADD_ANCHOR_0922(GeneralRecommender):
    def __init__(self, config, dataset):
        super(ALIGNREC_ADD_ANCHOR_0922, self).__init__(config, dataset)
        self.sparse = True
    ...
    def calculate_loss(self, interaction, not_train_ui=False):
        ...
        cl_anchor_loss = cl_id + self.lambda_weight * (cl_v + cl_t)
        ...
        if not_train_ui:
            return batch_emb_loss + cl_loss * self.cl_loss + cl_anchor_loss * self.lambda_weight + ii_sim_loss * self.sim_weight + batch_reg_loss
        return batch_mf_loss + batch_emb_loss + cl_loss * self.cl_loss + cl_anchor_loss * self.lambda_weight + ii_sim_loss * self.sim_weight + batch_reg_loss
