...
class FREEDOM_STORE(GeneralRecommender):
    def __init__(self, config, dataset):
        super(FREEDOM_STORE, self).__init__(config, dataset)
    ...
    def forward(self, adj, return_components=False):
        ...
        if return_components:
            return u_g_embeddings, i_g_embeddings + h, i_g_embeddings, h
    ...
    def full_sort_predict(self, interaction):
        ...
        restore_user_e, restore_item_e, id_item, mm_item = self.forward(self.norm_adj, return_components=True)
        u_embeddings = restore_user_e[user]

        save_dir = os.path.join("saved_emb", self.dataset_name, "FREEDOM")
