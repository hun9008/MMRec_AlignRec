...
try:
    ...
    from .alignrec_anchor_1028 import ALIGNREC_ANCHOR_1028
except Exception:
    # 상대 임포트가 환경에 따라 실패할 수 있으므로 절대 임포트 백업
    from models.alignrec import ALIGNREC
    from models.alignrec_anchor_1028 import ALIGNREC_ANCHOR_1028


_MODEL_REGISTRY = {
    "ALIGNREC": ALIGNREC,
    "ALIGNREC_ANCHOR_1028": ALIGNREC_ANCHOR_1028,
}


class ALIGNREC_ANCHOR_ENSEMBLE_A_1028(GeneralRecommender):
    """
    ...
    def __init__(self, config, dataset):
        ...
        self.model_name2 = str(config['agg_model2'] if 'agg_model2' in config else "ALIGNREC_ANCHOR_1028")
        # ...
        ...
        self.agg_lambda = config['agg_lambda']
    ...
    def full_sort_predict(self, interaction):
        ...
        # 가중 합산
        scores = self.agg_lambda * s1n + (1.0 - self.agg_lambda) * s2n
        return scores
