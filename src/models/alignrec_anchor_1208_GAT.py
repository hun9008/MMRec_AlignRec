...
class ALIGNREC_ANCHOR_1208_GAT(GeneralRecommender):
    def __init__(self, config, dataset):
        super(ALIGNREC_ANCHOR_1208_GAT, self).__init__(config, dataset)
        self.sparse = True
    ...
    def full_sort_predict(self, interaction):
        ...
        with torch.no_grad():
            ...
            if self.use_hist_decoder:
                ua_embeddings, ia_embeddings, side_embeds, content_embeds, t_embeds, v_embeds = self.forward(self.norm_adj, users=None, train=True)
