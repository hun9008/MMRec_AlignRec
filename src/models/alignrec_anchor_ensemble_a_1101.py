...
try:
    ...
    from .alignrec_anchor_1101 import ALIGNREC_ANCHOR_1101
except Exception:
    # 상대 임포트가 환경에 따라 실패할 수 있으므로 절대 임포트 백업
    from models.alignrec import ALIGNREC
    from models.alignrec_anchor_1101 import ALIGNREC_ANCHOR_1101


_MODEL_REGISTRY = {
    "ALIGNREC": ALIGNREC,
    "ALIGNREC_ANCHOR_1101": ALIGNREC_ANCHOR_1101,
}


class ALIGNREC_ANCHOR_ENSEMBLE_A_1101(GeneralRecommender):
    """
    ...
    def __init__(self, config, dataset):
        ...
        self.model_name2 = str(config['agg_model2'] if 'agg_model2' in config else "ALIGNREC_ANCHOR_1101")
        # ...
