...
class ANCHORREC_ABLATION_PROJ(GeneralRecommender):
    def __init__(self, config, dataset):
        super(ANCHORREC_ABLATION_PROJ, self).__init__(config, dataset)
        self.sparse = True
    ...
    def calculate_loss(self, interaction, not_train_ui=False):
        ...
        h_id_i_fusion = content_embeds_items
        h_mm_i_fusion = side_embeds_items
