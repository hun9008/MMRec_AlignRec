...
class ALIGNREC_ANCHOR_1015_T(GeneralRecommender):
    def __init__(self, config, dataset):
        super(ALIGNREC_ANCHOR_1015_T, self).__init__(config, dataset)
        self.sparse = True
    ...
    def calculate_loss(self, interaction, not_train_ui=False):
        ...
        if not_train_ui:
            return batch_emb_loss + cl_loss * self.cl_loss
        return batch_mf_loss + batch_emb_loss + cl_loss * self.cl_loss
