...
class Config(object):
    ...
    def __init__(self, model=None, dataset=None, config_dict=None, mg=False):
        ...
        # print(f"[DEBUG] _load final_config_dict after loading: {self.final_config_dict}")
        # config in cmd and main.py are latest
        self.final_config_dict.update(config_dict)
        # print(f"[DEBUG] final_config_dict after loading: {self.final_config_dict}")
    ...
    def _load_dataset_model_config(self, config_dict, mg):
        ...
        print(f"[DEBUG] overall.yaml file_list: {file_list}")
