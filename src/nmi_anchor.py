...
def run_nmi_evaluation(
    ...
    print("=" * 80)
    print("ANCHORREC NMI Calculation under the same clustering condition")
...
if __name__ == '__main__':
    ...
    parser.add_argument("--sample_size", type=int, default=70000)
    args = parser.parse_args()

    models = [
        (args.model, args.checkpoint_path),
    ]
