...
def compute_all_elbow_scores(
    ...
    print("=" * 80)
    print("ANCHORREC KMeans Elbow Method Calculation")
...
def save_elbow_plot(results, output_path):
    ...
    plt.title("ANCHORREC KMeans Elbow Method")
    plt.legend()
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--output_csv',
        type=str,
        default='cache_tsne/k_means_elbow_anchor.csv',
        help='CSV path to save k/inertia results. Use an empty string to skip.',
    )
    parser.add_argument(
        '--output_plot',
        type=str,
        default='cache_tsne/k_means_elbow_anchor.png',
