...
if __name__ == "__main__":
    ...
    plot_param_mean_metric_paperlike(
        log_path=f"./log/ANCHORREC-{data}-hyper.log",
        param_name="sim_weight",
        metric_name="recall@20",
        split="test",
        save_path=f"./hyper/{data}_sim_weight_recall20_test.png",
        show=False,
    ...
    plot_param_mean_metric_paperlike(
        ...
        metric_name="ndcg@20",
        split="test",
        save_path=f"./hyper/{data}_sim_weight_ndcg20_test.png",
        show=False,
        log_x=False,                     # x_equal_spacing=True면 log_x는 무시됨
        x_equal_spacing=True,
        annotate_n=False,                # 두번째 그림은 n 표기 거의 없음
    ...
    plot_param_mean_metric_paperlike(
        ...
        metric_name="recall@20",
        split="test",
        save_path=f"./hyper/{data}_cl_loss_recall20_test.png",
        show=False,
        log_x=False,                     # x_equal_spacing=True면 log_x는 무시됨
        x_equal_spacing=True,
        annotate_n=False,                # 두번째 그림은 n 표기 거의 없음
    ...
    plot_param_mean_metric_paperlike(
        ...
        metric_name="ndcg@20",
        split="test",
        save_path=f"./hyper/{data}_cl_loss_ndcg20_test.png",
        show=False,
        log_x=False,                     # x_equal_spacing=True면 log_x는 무시됨
        x_equal_spacing=True,
        annotate_n=False,                # 두번째 그림은 n 표기 거의 없음
